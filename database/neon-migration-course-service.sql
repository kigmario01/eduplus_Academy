-- =====================================================
-- MIGRACIÓN PARA NEON - COURSE SERVICE TABLES
-- =====================================================
-- Este script crea todas las tablas necesarias para el course-service
-- en la base de datos Neon de producción

-- Crear extensiones necesarias
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- =====================================================
-- TABLAS DE GESTIÓN DE CURSOS
-- =====================================================
...
CREATE TABLE IF NOT EXISTS courses (
    ...
    instructor_id INTEGER NOT NULL, -- Referencia a users del auth-service
...
CREATE TABLE IF NOT EXISTS course_enrollments (
    id SERIAL PRIMARY KEY,
    user_id INTEGER NOT NULL, -- Referencia a users del auth-service
    course_id INTEGER REFERENCES courses(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS conversations (
    ...
    course_id INTEGER REFERENCES courses(id) ON DELETE CASCADE,
    created_by INTEGER NOT NULL, -- Referencia a users del auth-service
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS messages (
    id SERIAL PRIMARY KEY,
    conversation_id INTEGER REFERENCES conversations(id) ON DELETE CASCADE,
    sender_id INTEGER NOT NULL, -- Referencia a users del auth-service
...
('Marketing', 'Cursos de marketing digital y estrategias de negocio'),
('Ciencias', 'Cursos de matemáticas, física, química y ciencias naturales'),
('Idiomas', 'Cursos de aprendizaje de idiomas extranjeros'),
('Negocios', 'Cursos de administración, finanzas y emprendimiento')
ON CONFLICT DO NOTHING;

-- Mensaje de confirmación
SELECT 'Migración completada exitosamente. Tablas del course-service creadas en Neon.' AS status;